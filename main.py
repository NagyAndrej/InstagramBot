...
channels = ["gentlemensgram","gentleman__classic","gentleman.jungle","thegentsjournal","prideandgrace","gentleman_does","onlyclassy","classybadassery","luxconduct"]
#POOL KOMENTáROV
comments = ["🔥🔥🔥","❤️❤️❤️","Awesome❤️","Nice❤️","Nice🔥","🔥❤️❤️","Great🔥","Wow🔥"]
#HASHTAGY NA VYHLADANIE FOTIEK
hashtags = ["classy", "classic", "luxury","luxurylifestyle","luxurylife","classywomen",
            "classymen", "classyvision","classiccar","classiccars","luxuryhomes","luxurytravel",
            "luxurystyle", "fashion"]

#METHODS
def start_log():

        __define_password = ""                                                                       #HESLO UCTU
        __define_username = "beesophisticated@gmail.com"                                             #USERNAME UCTU
        #TRY TO LOG
        try:
